...
function base_url_check_admin($path = ''): string
{
    if(check_auth()) {
...
// помогает удобно выводить ошибки валидации, оформляя их в HTML-код
...
// используется для заполнения полей формы при повторном отображении страницы после отправки формы (например, после валидационной ошибки).
